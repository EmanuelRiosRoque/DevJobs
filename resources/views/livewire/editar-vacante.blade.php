<form class="md:w-1/2 space-y-5" action="" wire:submit.prevent='editarVacante'>
    ...
    <div>
        ...
        <textarea class="w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm h-72" placeholder="Descripcion general del puesto" wire:model="descripcion" ></textarea>
        @error('descripcion')
            <livewire:mostrar-alerta :message="$message"/>
        @enderror
    </div>
    ...
    <div>
        ...
        <div class="flex justify-between">
            ...
            @if ($imagen_nueva)´
                <div class="w-96">
                    <p class="block text-sm text-gray-500 font-bold uppercase mb-2">Imagen Nueva:</p>
