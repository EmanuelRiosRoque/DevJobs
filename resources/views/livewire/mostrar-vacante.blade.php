<div class="p-10">
    <div class="mb-5">
        <h3 class="font-bold text-3xl text-gray-800 my-3">
            ...
            <div class=" md:grid md:grid-cols-2 py-4 my-10">
                <p class=" font-bold text-sm uppercase text-gray-800 my-3">Empresa:
                    <span class="normal-case font-normal">{{$vacante->empresa}}</span>
                </p>

                <p class=" font-bold text-sm uppercase text-gray-800 my-3">Ultimo dia para postularce:
    ...
    <div class="mt-5  bg-gray-50 border-dashed p-5 text-center">
        <p>
            ¿Deseas aplicar a esta vacante? <a href="{{route('register')}}" class="font-bold text-indigo-600">Obtener una cuenta y aplica a esta y otras vacantes</a>
        </p>
    </div>
    @endguest
